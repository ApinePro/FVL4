...
(function (global, factory) {
    ...
    _createClass(Alert, [{
      ...
      value: function _removeElement(element) {
        ...
        this._queueCallback(function () {
          return _this3._destroyElement(element);
        }, element, isAnimated);
      }
    }, {
      key: '_destroyElement',
  ...
  var Carousel = function (_BaseComponent3) {
    ...
    function Carousel(element, config) {
      ...
      var _this5 = _possibleConstructorReturn(this, (Carousel.__proto__ || Object.getPrototypeOf(Carousel)).call(this, element));
      ...
      _this5.touchStartX = 0;
      _this5.touchDeltaX = 0;
      _this5._config = _this5._getConfig(config);
      _this5._indicatorsElement = SelectorEngine.findOne(SELECTOR_INDICATORS, _this5._element);
      _this5._touchSupported = 'ontouchstart' in document.documentElement || navigator.maxTouchPoints > 0;
      _this5._pointerEvent = Boolean(window.PointerEvent);
    ...
    _createClass(Carousel, [{
      ...
      value: function _getConfig(config) {
        config = Object.assign({}, Default$9, Manipulator.getDataAttributes(this._element), (typeof config === 'undefined' ? 'undefined' : _typeof(config)) === 'object' ? config : {});
      ...
      value: function _addEventListeners() {
        ...
        if (this._config.keyboard) {
          EventHandler.on(this._element, EVENT_KEYDOWN, function (event) {
            return _this7._keydown(event);
          });
        }

        if (this._config.pause === 'hover') {
          EventHandler.on(this._element, EVENT_MOUSEENTER, function (event) {
            return _this7.pause(event);
          });
          EventHandler.on(this._element, EVENT_MOUSELEAVE, function (event) {
            return _this7.cycle(event);
          });
        }
      ...
      value: function _addTouchEventListeners() {
        ...
        var start = function start(event) {
          if (_this8._pointerEvent && (event.pointerType === POINTER_TYPE_PEN || event.pointerType === POINTER_TYPE_TOUCH)) {
            _this8.touchStartX = event.clientX;
          } else if (!_this8._pointerEvent) {
            _this8.touchStartX = event.touches[0].clientX;
          }
        };

        var move = function move(event) {
          // ensure swiping with one touch and not pinching
          _this8.touchDeltaX = event.touches && event.touches.length > 1 ? 0 : event.touches[0].clientX - _this8.touchStartX;
        };

        var end = function end(event) {
          if (_this8._pointerEvent && (event.pointerType === POINTER_TYPE_PEN || event.pointerType === POINTER_TYPE_TOUCH)) {
            _this8.touchDeltaX = event.clientX - _this8.touchStartX;
          }

          _this8._handleSwipe();

          if (_this8._config.pause === 'hover') {
            ...
            if (_this8.touchTimeout) {
              clearTimeout(_this8.touchTimeout);
            }

            _this8.touchTimeout = setTimeout(function (event) {
              return _this8.cycle(event);
            }, TOUCHEVENT_COMPAT_WAIT + _this8._config.interval);
          }
        };
      ...
      value: function _slide(directionOrOrder, element) {
        ...
        var triggerSlidEvent = function triggerSlidEvent() {
          EventHandler.trigger(_this9._element, EVENT_SLID, {
  ...
  var Collapse = function (_BaseComponent4) {
    ...
    function Collapse(element, config) {
      ...
      var _this10 = _possibleConstructorReturn(this, (Collapse.__proto__ || Object.getPrototypeOf(Collapse)).call(this, element));

      _this10._isTransitioning = false;
      _this10._config = _this10._getConfig(config);
      _this10._triggerArray = SelectorEngine.find(SELECTOR_DATA_TOGGLE$4 + '[href="#' + _this10._element.id + '"],' + (SELECTOR_DATA_TOGGLE$4 + '[data-bs-target="#' + _this10._element.id + '"]'));
      ...
      for (var i = 0, len = toggleList.length; i < len; i++) {
        ...
        var filterElement = SelectorEngine.find(selector).filter(function (foundElem) {
          return foundElem === _this10._element;
        });

        if (selector !== null && filterElement.length) {
          _this10._selector = selector;

          _this10._triggerArray.push(elem);
        }
      }

      _this10._parent = _this10._config.parent ? _this10._getParent() : null;

      if (!_this10._config.parent) {
        _this10._addAriaAndCollapsedClass(_this10._element, _this10._triggerArray);
      }
    ...
    _createClass(Collapse, [{
      ...
      value: function show() {
        ...
        if (this._parent) {
          actives = SelectorEngine.find(SELECTOR_ACTIVES, this._parent).filter(function (elem) {
            if (typeof _this11._config.parent === 'string') {
              return elem.getAttribute('data-bs-parent') === _this11._config.parent;
            }
        ...
        var complete = function complete() {
          ...
          _this11._element.classList.add(CLASS_NAME_COLLAPSE, CLASS_NAME_SHOW$8);

          _this11._element.style[dimension] = '';
          _this11.setTransitioning(false);
          EventHandler.trigger(_this11._element, EVENT_SHOWN$5);
        };
      ...
      value: function hide() {
        ...
        var complete = function complete() {
          ...
          EventHandler.trigger(_this12._element, EVENT_HIDDEN$5);
        };
      ...
      value: function _getParent() {
        ...
        SelectorEngine.find(selector, parent).forEach(function (element) {
          ...
          _this13._addAriaAndCollapsedClass(selected, [element]);
        });
        return parent;
      }
    }, {
      ...
      value: function collapseInterface(element, config) {
        ...
        var _config = Object.assign({}, Default$8, Manipulator.getDataAttributes(element), (typeof config === 'undefined' ? 'undefined' : _typeof(config)) === 'object' && config ? config : {});
  ...
  */
  ...
  var Dropdown = function (_BaseComponent5) {
    ...
    function Dropdown(element, config) {
      ...
      var _this14 = _possibleConstructorReturn(this, (Dropdown.__proto__ || Object.getPrototypeOf(Dropdown)).call(this, element));

      _this14._popper = null;
      _this14._config = _this14._getConfig(config);
      _this14._menu = _this14._getMenuElement();
      _this14._inNavbar = _this14._detectNavbar();

      _this14._addEventListeners();
      return _this14;
    } // Getters
    ...
    _createClass(Dropdown, [{
      ...
      value: function dataApiKeydownHandler(event) {
        ...
        var getToggleButton = function getToggleButton() {
          return _this17.matches(SELECTOR_DATA_TOGGLE$3) ? _this17 : SelectorEngine.prev(_this17, SELECTOR_DATA_TOGGLE$3)[0];
        };
  ...
  var Backdrop = function () {
    ...
    _createClass(Backdrop, [{
      ...
      key: '_getConfig',
      value: function _getConfig(config) {
        config = Object.assign({}, Default$6, (typeof config === 'undefined' ? 'undefined' : _typeof(config)) === 'object' ? config : {}); // use getElement() with the default "body" to get a fresh Element on each instantiation
  ...
  var Modal = function (_BaseComponent6) {
    ...
    function Modal(element, config) {
      ...
      var _this21 = _possibleConstructorReturn(this, (Modal.__proto__ || Object.getPrototypeOf(Modal)).call(this, element));
    ...
    _createClass(Modal, [{
      ...
      value: function show(relatedTarget) {
        ...
        EventHandler.on(this._dialog, EVENT_MOUSEDOWN_DISMISS, function () {
          EventHandler.one(_this22._element, EVENT_MOUSEUP_DISMISS, function (event) {
            if (event.target === _this22._element) {
      ...
      key: '_getConfig',
      value: function _getConfig(config) {
        config = Object.assign({}, Default$5, Manipulator.getDataAttributes(this._element), (typeof config === 'undefined' ? 'undefined' : _typeof(config)) === 'object' ? config : {});
      ...
      value: function _showElement(relatedTarget) {
        ...
        var transitionComplete = function transitionComplete() {
          ...
          EventHandler.trigger(_this24._element, EVENT_SHOWN$3, {
            relatedTarget: relatedTarget
          });
        };
      ...
      value: function _enforceFocus() {
        ...
        EventHandler.on(document, EVENT_FOCUSIN$2, function (event) {
          if (document !== event.target && _this25._element !== event.target && !_this25._element.contains(event.target)) {
  ...
  var Offcanvas = function (_BaseComponent7) {
    ...
    function Offcanvas(element, config) {
      ...
      var _this32 = _possibleConstructorReturn(this, (Offcanvas.__proto__ || Object.getPrototypeOf(Offcanvas)).call(this, element));
    ...
    _createClass(Offcanvas, [{
      ...
      key: '_getConfig',
      value: function _getConfig(config) {
        config = Object.assign({}, Default$4, Manipulator.getDataAttributes(this._element), (typeof config === 'undefined' ? 'undefined' : _typeof(config)) === 'object' ? config : {});
  ...
  var Tooltip = function (_BaseComponent8) {
    ...
    function Tooltip(element, config) {
      ...
      var _this38 = _possibleConstructorReturn(this, (Tooltip.__proto__ || Object.getPrototypeOf(Tooltip)).call(this, element));

      _this38._isEnabled = true;
      _this38._timeout = 0;
      _this38._hoverState = '';
      _this38._activeTrigger = {};
      _this38._popper = null; // Protected
    ...
    _createClass(Tooltip, [{
      ...
      value: function hide() {
        ...
        var complete = function complete() {
          ...
          if (_this40._popper) {
            _this40._popper.destroy();

            _this40._popper = null;
          }
        };
      ...
      value: function _getConfig(config) {
        ...
        config = Object.assign({}, this.constructor.Default, dataAttributes, (typeof config === 'undefined' ? 'undefined' : _typeof(config)) === 'object' && config ? config : {});
  ...
  var Popover = function (_Tooltip) {
    ...
    _createClass(Popover, [{
      ...
      value: function getTipElement() {
        ...
        this.tip = _get(Popover.prototype.__proto__ || Object.getPrototypeOf(Popover.prototype), 'getTipElement', this).call(this);
  ...
  var ScrollSpy = function (_BaseComponent9) {
    ...
    function ScrollSpy(element, config) {
      ...
      var _this45 = _possibleConstructorReturn(this, (ScrollSpy.__proto__ || Object.getPrototypeOf(ScrollSpy)).call(this, element));

      _this45._scrollElement = _this45._element.tagName === 'BODY' ? window : _this45._element;
      _this45._config = _this45._getConfig(config);
      _this45._selector = _this45._config.target + ' ' + SELECTOR_NAV_LINKS + ', ' + _this45._config.target + ' ' + SELECTOR_LIST_ITEMS + ', ' + _this45._config.target + ' .' + CLASS_NAME_DROPDOWN_ITEM;
      _this45._offsets = [];
      _this45._targets = [];
      _this45._activeTarget = null;
      _this45._scrollHeight = 0;
      EventHandler.on(_this45._scrollElement, EVENT_SCROLL, function () {
        return _this45._process();
      });
      _this45.refresh();
    ...
    _createClass(ScrollSpy, [{
      ...
      value: function refresh() {
        ...
        targets.map(function (element) {
          ...
          _this46._offsets.push(item[0]);

          _this46._targets.push(item[1]);
        });
      }
    }, {
      key: 'dispose',
      ...
      key: '_getConfig',
      value: function _getConfig(config) {
        config = Object.assign({}, Default$1, Manipulator.getDataAttributes(this._element), (typeof config === 'undefined' ? 'undefined' : _typeof(config)) === 'object' && config ? config : {});
  ...
  var Tab = function (_BaseComponent10) {
    ...
    _createClass(Tab, [{
      ...
      value: function show() {
        ...
        var complete = function complete() {
          EventHandler.trigger(previous, EVENT_HIDDEN$1, {
            relatedTarget: _this48._element
          });
          EventHandler.trigger(_this48._element, EVENT_SHOWN$1, {
            relatedTarget: previous
          });
        };
      ...
      value: function _activate(element, container, callback) {
        ...
        var complete = function complete() {
          return _this49._transitionComplete(element, active, callback);
        };
  ...
  var Toast = function (_BaseComponent11) {
    ...
    function Toast(element, config) {
      ...
      var _this50 = _possibleConstructorReturn(this, (Toast.__proto__ || Object.getPrototypeOf(Toast)).call(this, element));

      _this50._config = _this50._getConfig(config);
      _this50._timeout = null;
      _this50._hasMouseInteraction = false;
      _this50._hasKeyboardInteraction = false;

      _this50._setListeners();
      return _this50;
    } // Getters
    ...
    _createClass(Toast, [{
      ...
      value: function show() {
        ...
        var complete = function complete() {
          _this51._element.classList.remove(CLASS_NAME_SHOWING);

          _this51._element.classList.add(CLASS_NAME_SHOW);

          EventHandler.trigger(_this51._element, EVENT_SHOWN);

          _this51._maybeScheduleHide();
        };
      ...
      value: function hide() {
        ...
        var complete = function complete() {
          _this52._element.classList.add(CLASS_NAME_HIDE);

          EventHandler.trigger(_this52._element, EVENT_HIDDEN);
        };
      ...
      key: '_getConfig',
      value: function _getConfig(config) {
        config = Object.assign({}, Default, Manipulator.getDataAttributes(this._element), (typeof config === 'undefined' ? 'undefined' : _typeof(config)) === 'object' && config ? config : {});
      ...
      value: function _setListeners() {
        ...
        EventHandler.on(this._element, EVENT_MOUSEOVER, function (event) {
          return _this54._onInteraction(event, true);
        });
        EventHandler.on(this._element, EVENT_MOUSEOUT, function (event) {
          return _this54._onInteraction(event, false);
        });

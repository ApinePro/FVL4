  ...
  _createClass(OtherPlayer, [{
    ...
    value: function render() {
      return React.createElement(
        ...
        React.createElement(
          'p',
          { style: { fontFamily: "verdana", fontSize: "80%" } },
...
var PlayContainer = function (_React$Component5) {
  ...
  function PlayContainer(props) {
    ...
    _this7.handleSendFunc = _this7.sendFunc.bind(_this7);
    _this7.state = {
  ...
  _createClass(PlayContainer, [{
    ...
    value: function sendFunc(cards) {
      ...
      this.setState({
        ...
        console.log("state in sendFunc");console.log(_this8.state.onboard_cards);_this8.render();
      });
    }
  }, {
    key: 'render',
